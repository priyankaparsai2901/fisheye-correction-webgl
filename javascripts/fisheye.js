...
var FisheyeDistorter = function FisheyeDistorter(options) {
    ...
    var vertexSrc = shaders.vertex;
    var fragmentSrc = shaders.fragment3;
    ...
    function getImage() {
        var img = new Image();
        img.src = gl.canvas.toDataURL('image/jpeg');
        return img;
    }

    function getSrc() {
        return gl.canvas.toDataURL('image/jpeg');
    }
...
window.FisheyeDistorter = FisheyeDistorter;
